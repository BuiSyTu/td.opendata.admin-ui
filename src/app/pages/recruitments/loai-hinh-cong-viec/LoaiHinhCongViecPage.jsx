...
const CustomPage = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        var res = await requestGET(
          `${HOST_API}/JobType?orderBy=name&keySearch=${inputValue}&pageNumber=${offset}&pageSize=${size}`
        );
  ...
  const handleDelete = async (id) => {
    var res = await requestDELETE(`${HOST_API}/JobType/${id}`);
    if (res) {
  ...
  return (
    <div>
      <PageTitle breadcrumbs={[]}>Danh mục loại hình công việc</PageTitle>
