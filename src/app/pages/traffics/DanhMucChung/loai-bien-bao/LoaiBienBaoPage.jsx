...
import {Row, Col, Typography, Divider, Input, Button, Popconfirm, notification, Image} from 'antd';
...
const CustomPage = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        var res = await requestGET(
          `${HOST_API}/trafficsigntype?keySearch=${inputValue}&pageNumber=${offset}&pageSize=${size}`
        );
  ...
  const handleDelete = async (id) => {
    var res = await requestDELETE(`${HOST_API}/trafficsigntype/${id}`);
    if (res) {
  ...
  return (
    <div>
      <PageTitle breadcrumbs={[]}>Danh mục loại biển báo</PageTitle>
