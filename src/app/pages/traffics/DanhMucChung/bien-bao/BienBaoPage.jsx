...
const CustomPage = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        var res = await requestGET(
          `${HOST_API}/trafficsign?keySearch=${inputValue}&pageNumber=${offset}&pageSize=${size}`
        );
  ...
  const handleDelete = async (id) => {
    var res = await requestDELETE(`${HOST_API}/trafficsign/${id}`);
    if (res) {
  ...
  return (
    <div>
      <PageTitle breadcrumbs={[]}>Danh mục biển báo</PageTitle>
