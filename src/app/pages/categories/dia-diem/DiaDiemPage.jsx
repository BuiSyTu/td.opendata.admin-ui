...
const TypePaperPage = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        var res = await requestGET(
          `${HOST_API}/Place?orderBy=name&keySearch=${inputValue}&pageNumber=${offset}&pageSize=${size}`
        );
  ...
  const handleDelete = async (id) => {
    var res = await requestDELETE(`${HOST_API}/Place/${id}`);
    if (res) {
  ...
  return (
    <div>
      <PageTitle breadcrumbs={[]}>Danh sách địa điểm</PageTitle>
