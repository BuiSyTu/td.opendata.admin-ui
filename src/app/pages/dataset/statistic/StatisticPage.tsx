...
const StatisticPage: React.FC<StatisticPageProps> = ({ dataTypeCode, isPortal }) => {
    ...
    return (
        <>
            ...
            <div className='card mb-5 mb-xl-12 p-15'>
                ...
                <Row>
                    <Col span={12}>
                        <p className='lead'>Số tập dữ liệu: 12</p>
                    </Col>
                    <Col span={12}>
                        <p className='lead'>Tổng lượt xem: 563</p>
                    </Col>
                </Row>

                <Row>
                    <Col span={12}>
                        <p className='lead'>Số lần đông bộ: 26</p>
                    </Col>
                    <Col span={12}>
                        <p className='lead'>Được xuất bản lên cổng: 8</p>
                    </Col>
                </Row>

                <Row>
                    <Col span={12}>
                        <p className='lead'>Số tổ chức đẩy dữ liệu lên: 3</p>
                    </Col>
                    <Col span={12}>
                        <p className='lead'>Số hình thức cung cấp: 2</p>
                    </Col>
                </Row>

                <Row>
                    <Col span={12}>
                        <p className='lead'>Số giấy phép cấp: 2</p>
                    </Col>
                </Row>
            </div>
        </>
